...
2. [Module Overview](#module-overview)
   ...
   * [4. LINQ Fundamentals & Deferred Execution](#4-linq-fundamentals--deferred-execution)
...
* [ ] **Module 7: Design Patterns & Architecture**
  * *Space reserved for Repository Pattern, Unit of Work, Factory Pattern, and Clean Architecture patterns.*
